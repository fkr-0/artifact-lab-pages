...
assert.equal(nakamotosProvenance.sourceRevision, 'b4de8ea5b0add02dfbf808c90a27396146114bf0');
assert.equal(nakamotosProvenance.sourceVersion, '0.2.0-alpha.10');
...
assert.doesNotMatch(nakamotosChecksums, /\.map$/m);
