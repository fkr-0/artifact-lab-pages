...
assert.match(html, /id="paletteDropZone"/, 'v11 palette generator should support image drag and drop');
...
assert.match(html, /id="paletteContrastReport"/, 'v11 palette generator should expose contrast metrics');
assert.match(html, /data-palette-role/, 'v11 palette roles should be directly editable');
...
assert.match(html, /image-palette\.mjs/, 'v11 should use the shared image palette engine');
assert.match(html, /evaluateRolePalette/, 'v11 should evaluate palette accessibility');
