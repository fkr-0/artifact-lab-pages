...
const COMMAND_PEDAGOGY: Record<string, CommandPedagogy> = {
  init: {
    ...
    outcome:
      'Creates the hidden .git directory. The visible files do not change yet, but Git now has a place to store history.',
  ...
  rebase: {
    ...
    safetyNote:
      'Rebase rewrites history. Practice here first; on real projects, do not rebase commits other people already pulled unless coordinated.',
  },
  remote: {
...
const CATEGORIES: ILessonCategory[] = [
  ...
  { id: 'branching', title: 'Branching', icon: '🌿', description: 'Working with branches', order: 1, color: '#f59e0b' },
  {
    ...
    icon: '🔀',
    description: 'Combining and reorganizing history',
    order: 2,
    color: '#8b5cf6',
  },
  {
    ...
    steps: [
      {
        ...
        description:
          'Git helps you record meaningful snapshots, compare versions, recover from mistakes, and share work without emailing file copies around.',
      ...
      },
      {
        ...
        description:
          'A repository contains your visible project files plus a hidden .git database that stores history and branch metadata.',
        hint: 'Inspect the concept; the first real command will create this structure later.',
        concept:
          'Visible files are the meal you are cooking. The .git directory is the recipe notebook and timeline behind it.',
        toolIntroductions: [
          {
            term: 'repository',
      ...
      },
      {
        ...
        description:
          'Git beginners need three places: files you are editing, changes selected for the next snapshot, and snapshots already recorded.',
      ...
      },
      {
        ...
        description:
          'Use status before and after commands, prefer small commits, and treat destructive commands as deliberate recovery tools.',
    ...
    steps: [
      {
        ...
        description:
          'Repository, working tree, staging area, commit, branch, HEAD, remote, fetch, merge, rebase, and reset are introduced before they become commands.',
        hint: 'Use this as a reference panel when a later command contains an unfamiliar word.',
        concept:
          'A glossary lowers entry barrier by making the language explicit instead of assuming prior terminal or Git knowledge.',
        toolIntroductions: [
          {
            term: 'repository',
            meaning: 'A Git-tracked project folder.',
            usedHere: 'The place every command operates on.',
          },
          {
            term: 'branch',
            meaning: 'A movable name pointing to a commit.',
            usedHere: 'Lets one line of work move independently.',
          },
          {
            term: 'remote',
            meaning: 'A named link to another repository copy.',
            usedHere: 'Lets local and shared history communicate.',
          },
        ],
    ...
    steps: [
      {
        ...
        concept:
          'Safety in Git comes from knowing which layer changes: working tree, staging area, branch pointer, or remote branch.',
        toolIntroductions: [
          {
            term: 'inspect commands',
            meaning: 'Commands like status, log, branch, and remote -v mainly read state.',
            usedHere: 'Use them freely to orient yourself.',
          },
          {
            term: 'destructive commands',
            meaning: 'Commands that can discard files or rewrite history.',
            usedHere: 'Use reset --hard and rebase only with a clear plan.',
          },
        ],
        ...
        safetyNote:
          'Always orient with status/log and consider a backup branch before commands that discard work or rewrite shared history.',
      },
    ],
  },
  {
        ...
        toolIntroductions: [
          {
            ...
            meaning: 'Remembering before rereading.',
            usedHere: 'Used here to stabilize Git mental models.',
          },
          {
            term: 'spacing',
            meaning: 'Reviewing after delay instead of immediately repeating.',
            usedHere: 'Used here to revisit core concepts after later lessons.',
          },
        ],
    ...
    steps: [
      {
        ...
        description:
          'Given a goal, orient yourself, create or switch to a branch, stage focused changes, commit, inspect history, and prepare to share.',
        ...
        toolIntroductions: [
          {
            term: 'goal-directed practice',
            meaning: 'Choosing commands based on intent instead of copying exact text.',
            usedHere: 'This is the transition from tutorial to usable skill.',
          },
          {
            term: 'self-check',
            meaning: 'Verifying your own state after each action.',
            usedHere: 'Use status, branch, and log to confirm progress.',
          },
        ],
    ...
    steps: [
      {
        ...
        description:
          'Every Git project starts with `git init`. This creates a new repository in your current directory.',
        hint: 'Type: git init',
      ...
      },
      {
        ...
        concept:
          'The working directory is your kitchen counter — where you prepare and modify recipes before recording them.',
      ...
      },
      {
        ...
        description:
          'Use `git add .` to stage all changes. Staging is like putting recipes on a tray, ready to be photographed.',
        hint: 'Type: git add .',
        concept:
          'The staging area (index) is like a photo studio — you arrange exactly what you want to capture before taking the snapshot.',
      ...
      },
      {
        ...
        description:
          "A commit is a snapshot of your staged changes. It's like taking a photo of your recipe collection at this moment.",
        hint: 'Type: git commit -m "Initial commit"',
        concept:
          'A commit permanently records the state of your staged files. Each commit gets a unique hash ID and links to its parent, forming a chain.',
      ...
      },
      {
        ...
        hint: 'Type: git log',
        concept:
          "Git log shows the commit chain — each commit points to its parent, creating a timeline of your project's history.",
    ...
    steps: [
      {
        ...
        description:
          'Branches let you diverge from the main line of development. Think of it as starting a new chapter in your cookbook.',
        hint: 'Type: git branch desserts',
        concept:
          "A branch is just a movable pointer to a commit. Creating a branch doesn't copy files — it just creates a new label.",
      ...
      },
      {
        ...
        concept:
          'When you checkout a branch, Git updates your working directory to match the commit that branch points to. HEAD now points to this branch.',
      ...
      },
      {
        ...
        concept:
          'When you commit on a branch, only that branch pointer moves forward. The main branch stays where it was.',
        validation: { type: 'regex', pattern: '^git\\s+commit\\s+-m\\s+".+"$' },
      },
      {
        id: 'checkout-main',
        ...
        concept:
          "Switching branches restores the working directory to that branch's state. Your branch's commits are safe even when you switch away.",
  ...
  // ─── MERGING ─────────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        hint: 'Type: git log',
        concept:
          'Merge commits have two parent IDs. This is what creates the diamond shape in the git graph — both branches converge.',
        validation: { type: 'regex', pattern: '^git\\s+log$' },
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        concept:
          'Unlike merge, rebase doesn\'t create a merge commit. It "replays" your commits on top of the target, creating new commits with the same changes but new IDs.',
    ...
    steps: [
      {
        ...
        hint: 'Type: git init',
        concept:
          'Your local repo is your personal workspace. A remote is a shared space where collaborators exchange their work — like a community cookbook shelf.',
        validation: { type: 'regex', pattern: '^git\\s+init$' },
      },
      {
        id: 'remote-add',
        ...
        concept:
          'A remote is a bookmark pointing to another copy of the repository — usually on GitHub, GitLab, or a server. "origin" is the conventional name for the primary remote.',
      ...
      },
      {
        ...
        concept:
          'The -v flag shows the URL for each remote. You can have multiple remotes — e.g., "origin" for your fork and "upstream" for the original project.',
      ...
      },
      {
        ...
        concept:
          "Fetch is like checking your mailbox — you see what arrived but don't open it yet. It updates remote-tracking branches (origin/main) but leaves your local branches and working directory untouched. This is safe!",
    ...
    steps: [
      {
        ...
        hint: 'Type: git fetch origin',
        concept:
          "Always fetch before pull to see what's coming. This gives you a chance to inspect the changes before they affect your work.",
        validation: { type: 'regex', pattern: '^git\\s+fetch\\s+\\S+' },
      },
      {
        id: 'pull-exec',
      ...
      },
      {
        ...
        hint: 'Type: git status',
        concept:
          "After a pull, git status shows if your branch is up to date with the remote. The tracking relationship means Git can tell you if you're ahead, behind, or diverged.",
        validation: { type: 'regex', pattern: '^git\\s+status$' },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        hint: 'Type: git remote add origin https://github.com/chef/recipe-book.git',
        concept:
          'You need a remote configured before you can push. The remote URL tells Git where to send your commits.',
        validation: { type: 'regex', pattern: '^git\\s+remote\\s+add\\s+\\S+\\s+\\S+' },
      },
      {
        id: 'push-commit',
        ...
        concept:
          "You can only push commits that exist locally. Make sure you've committed everything you want to share.",
        validation: { type: 'regex', pattern: '^git\\s+commit\\s+-m\\s+".+"$' },
      },
      {
        id: 'push-exec',
      ...
      },
      {
        ...
        hint: 'Type: git status',
        concept:
          'After pushing, your branch should be "up to date" with the remote. The graph shows both your local and remote-tracking branch at the same commit.',
        validation: { type: 'regex', pattern: '^git\\s+status$' },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        hint: 'Type: git fetch origin',
        concept:
          'In a real workflow, someone else may have pushed to the remote while you were working. Fetch regularly to stay aware of their changes.',
        validation: { type: 'regex', pattern: '^git\\s+fetch\\s+\\S+' },
      },
      {
        ...
        concept:
          'After fetching, you can merge the remote-tracking branch into your local branch. This is what git pull does automatically — but doing it step by step gives you more control.',
      ...
      },
      {
        ...
        hint: 'Type: git push origin main',
        concept:
          'After merging remote changes, your local branch includes both your work and theirs. Pushing updates the remote so others can see the integrated result. This is the collaboration loop: fetch → merge → push.',
        validation: { type: 'regex', pattern: '^git\\s+push\\s+\\S+\\s+\\S+' },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        hint: 'Type: git log',
        concept:
          'Tags are stable labels for commits. Branches move as work continues; tags are intended to stay attached to one important commit.',
        validation: { type: 'regex', pattern: '^git\\s+log$' },
        toolIntroductions: [
          {
            term: 'tag',
      ...
      },
      {
        ...
        concept:
          'A lightweight tag is a direct label on a commit. It is useful for local practice and simple milestones.',
    ...
    steps: [
      {
        ...
        description:
          'Cherry-pick applies a commit onto the branch you are currently on, so start by checking where HEAD is.',
        hint: 'Type: git branch',
      ...
      },
      {
        ...
        concept:
          'Git replays the patch from the selected commit. The result is a new commit with a different hash on your current branch.',
        validation: { type: 'regex', pattern: '^git\\s+cherry-pick\\s+\\S+$' },
        safetyNote:
          'Cherry-pick duplicates a change onto the current branch and may stop for conflicts if the copied patch overlaps local work.',
        toolIntroductions: [
          {
            term: 'cherry-pick',
            ...
            beginnerPitfall:
              'The new commit has a different hash, so it is a duplicate change, not the same commit object.',
          },
          {
            term: '<commit-hash>',
      ...
      },
      {
        ...
        hint: 'Type: git status',
        concept:
          'Verification matters after cherry-pick because conflicts or partial changes should be resolved before continuing.',
        validation: { type: 'regex', pattern: '^git\\s+status$' },
        expectedOutcome:
          'Status is clean or clearly reports conflict work to finish; history shows the new copied commit.',
    ...
    steps: [
      {
        ...
        hint: 'Type: git stash',
        concept:
          'Stash is like putting your current work in a drawer. You can pop it back later. Great for when you need to switch tasks quickly.',
      ...
      },
      {
        ...
        hint: 'Type: git tag v1.0',
        concept:
          "Tags are permanent bookmarks pointing to specific commits. Unlike branches, they don't move when you make new commits.",
        validation: { type: 'regex', pattern: '^git\\s+tag\\s+\\S+$' },
      },
      {
        id: 'reset',
        ...
        concept:
          'Reset moves the branch pointer to a previous commit. --hard also changes your working directory. Use with caution!',
      ...
      },
      {
        ...
        hint: 'Type: git cherry-pick <commit-hash>',
        concept:
          'Cherry-pick lets you grab just one commit from anywhere and apply it to your current branch — like picking one recipe from another cookbook.',
        validation: { type: 'regex', pattern: '^git\\s+cherry-pick\\s+\\S+$' },
      },
    ],
  },
...
export class LessonProvider implements ILessonRegistry {
  ...
  validateStep(lessonId: string, stepIndex: number, rawCommand: string, gitState: Record<string, unknown>): boolean {
    const lesson = this.lessons.get(lessonId)
