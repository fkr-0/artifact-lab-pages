import type { ComponentSlot, IComponentOverride, IUXAction, IUXFlow, IUXRegistry, UXTrigger } from './interfaces'
...
export class UXRegistry implements IUXRegistry {
  ...
  registerOverride(override: IComponentOverride): void {
    ...
    this.overrides.set(slot, existing)
