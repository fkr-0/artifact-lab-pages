...
export class PeerBridgeModule extends ModuleBase {
  constructor(config = {}) {
    super({
      ...
      kind: 'network',
      inputs: [{ id: 'control', type: PortType.CONTROL }, { id: 'midi', type: PortType.MIDI }],
      outputs: [{ id: 'control', type: PortType.CONTROL }, { id: 'midi', type: PortType.MIDI }]
    });
  ...
  render() {
    ...
    `;
    this.root.querySelector('button').addEventListener('click', () => this.connect(this.root.querySelector('input').value || 'pilot'));
  }
}
