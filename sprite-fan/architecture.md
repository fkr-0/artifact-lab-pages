...
The current pass hardened the single-file artifact with static contracts and end-to-end browser coverage for the main postprocessing workflows:
...
3. GIF import/export is actually merged into the studio.
...
GIF features should be added later as focused import/export modules, not by copying the full GIF creator UI.
