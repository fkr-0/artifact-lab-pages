...
Think of yourself as the adhesive bandage of the medical world: temporary,
essential, and way better than nothing.

This chapter is a prompt, not a first-aid qualification. It covers triage,
wounds, burns, fractures, vital observations, pain notes, waiting plans, and
psychological parallels. A home measurement can add information; it cannot
certify that a serious situation is harmless.

> **Emergency gate:** if someone is unresponsive, not breathing normally,
> bleeding severely, showing stroke signs, or in acute danger — call **112**
> right now, **put the phone on speaker**, unlock the door if safe, and read the
> matching section below while the dispatcher talks you through it.
> **You are not wasting their time. The system exists for this.**

::: {.infobox}

**112 — What happens when you call**

- **112** is the EU-wide emergency number. It works from any phone, any network,
  even without a SIM card. On GSM networks it routes to the nearest Public Safety
  Answering Point (PSAP) — the dispatcher sees your approximate location
  automatically.
- **116 117** is the German non-emergency medical on-call number
  (*Kassenärztlicher Bereitschaftsdienst*). Use it for urgent but not
  life-threatening situations outside practice hours — it connects you to a
  doctor, not an ambulance.
- When in doubt between 112 and 116 117: **call 112**. They will redirect you if
  appropriate. Over-calling is always safer than under-calling.
...
::: {.principle}
*help, and try to save a life*
:::

- Call **112** and send someone for an AED (automated external defibrillator) if available.
- Begin CPR (cardiopulmonary resuscitation) — chest compressions in the centre
  of the adult chest: **100--120 per minute**, **5--6 cm** deep, allowing full recoil.
...
- **30 compressions** — imitates the heart's pumping action, pushing blood to the brain
- **2 breaths** — provides oxygen; skip if untrained, compressions alone still help
- **Switch rescuers** — prevents fatigue; tired compressions become shallow
- **AED** — applies targeted electrical stimulation to restart a normal rhythm

:::

**The dispatcher can guide you through every step. Put the phone on speaker.**
Imperfect compressions are better than elegant inaction.[^erc2025]

## Unresponsive but breathing normally

::: {.principle}
*achieve a safe position while waiting for help*
:::
...
Porcelain is a poor witness. If someone faints and you did not see it happen,
**treat any head injury as real until a clinician says otherwise.**

## Choking

::: {.principle}
*coughing is good — do not interfere with effective coughing*
:::
...
::: {.principle}
*do not add harm — try to reduce damage and support the body's self-repair*
:::

### Minor wound

::: {.principle}
*prevent infection, support self-repair*
:::

- Wash or sanitize your hands — do not introduce infections on top.
- Rinse visible dirt with clean water — remove contamination without adding harm.
...
::: {.principle}
*stop bleeding while trying not to make it worse*
:::
...
when appropriate. Do not abandon direct pressure to search for perfect
gear.[^drk-bleeding]

### Shock warning signs

::: {.principle}
*reduce stress, support physiological functioning while waiting for professional help*
:::
...
::: {.principle}
*assess severity, do not overcool, cool*
:::
...
- Cool a limited burn promptly with cool or cold running water for about
  **20 minutes**, while preventing whole-body chilling.
- Be especially cautious with large burns, infants, children, and frail people;
  call **112** and prioritize warmth as instructed.
...
The exact cooling advice varies slightly among guidelines; current DRK public
guidance uses at least 20 minutes and strongly warns against
hypothermia.[^drk-burns]

## Suspected fractures and joint injuries

::: {.principle}
*the body chose its position — support it*
:::
...
2. Support it in the position found using clothing, pillows, blankets, or other
   padding.
...
5. Call **112** for open fracture, severe deformity, major trauma, impaired
   circulation or sensation, spine/pelvis injury, or serious concern.
6. Otherwise arrange urgent medical assessment.

Improvised rigid splints can cause harm when applied badly. For a short wait,
comfortable padding and stillness are often more useful than constructing a
medieval orthopaedic device from magazines.[^drk-fracture]

## Suspected spine, neck, or pelvic injury

::: {.principle}
*unless absolutely necessary — do. not. move. support.*
:::
...
- **T -- Time:** call **112 immediately** and note when the person was last
  known well.
...
Every minute matters in a large-vessel stroke. The research literature estimates
neural losses on the order of 1.9 million neurons per minute during a typical
untreated large-vessel ischaemic stroke -- an order-of-magnitude model, not a
tissue count you can observe at home, but the lay conclusion is simple: a
sudden FAST sign gets **112 now**, not a timer, a spreadsheet, or a request to
finish the sentence first.[^time-brain]

## Chest pain or severe breathlessness

Call **112** for strong chest pressure or pain, severe breathlessness, cold
sweat, collapse, pain spreading to arm/jaw/back, blue or grey colour, or
serious uncertainty. Let the person rest in the position that makes breathing
...
- Otherwise call a German poison information centre; gesund.bund.de maintains
  the official directory and explains when to use 112.
...
Devices can be wrong because of cold fingers, movement, nail products, cuff
size, poor circulation, battery, or user technique. A reassuring display is not
...
Record location, onset, quality, what changed it, and a 0--10 rating if
helpful. A pain number is communication, not triage. Contact a practice or
**116 117** when the problem is urgent but not life-threatening, especially if
pain is new, persistent, worsening, or impairing function.[^emergency-numbers]

Do not exceed labelled or prescribed medication doses. Check active ingredients
to avoid accidentally taking the same medicine under two brand names. Ask a
...
- Do not give food or drink to someone with reduced consciousness, choking risk,
  severe nausea, or possible surgery unless instructed.
- Recheck responsiveness and breathing.
- Tell the dispatcher immediately if the condition changes.

Do not tell someone to "fight unconsciousness." Keep them safe, monitor
breathing, and call for help. Consciousness is not maintained by motivational
speaking.
...
situational crises, but the actions differ:
...
Medicine recognises **situational syncope**: fainting associated with triggers
such as urination, defecation, coughing, visceral pain, heat, or
straining.[^situational-syncope] Bathrooms combine several of these triggers
with hard edges. Porcelain is a poor witness.

Warning signs include nausea, sweating, pallor, dizziness, dimming vision, and
a sudden sense that standing has become an unconvincing idea.

If that pattern starts:

- stop straining
- sit securely or lie down rather than trying to "push through"
- lower the chance of a fall — get away from the tub edge, lower your centre
...
Any single red flag means call **112**.
...
[^drk-burns]: German Red Cross, "Verbrennungen, Verbr&uuml;hungen und Brandwunden": https://www.drk.de/hilfe-in-deutschland/erste-hilfe/verbrennungen/

[^drk-fracture]: German Red Cross, "Knochenbr&uuml;che": https://www.drk.de/hilfe-in-deutschland/erste-hilfe/knochenbruch/knochenbrueche/

[^emergency-numbers]: gesund.bund.de, "Nummern f&uuml;r den Notfall": https://gesund.bund.de/notfallnummern
