...
# First-aid routing
fig, ax = canvas((8.27, 8.6), (0, 10), (0, 10))
ax.text(5, 9.55, "FIRST-AID FIRST MINUTE", ha="center", color=INK, fontsize=20, fontweight="bold")
box(ax, 5, 8.4, 5.4, .8, "Scene safe to approach?", AMBER, 11)
box(ax, 2.2, 6.8, 3.1, .8, "Stay back · call 112", RED, 10)
box(ax, 6.5, 6.8, 4.0, .8, "Responsive and breathing normally?", GREEN, 10)
arrow(ax, (3.5, 8.05), (2.45, 7.22), "NO", RED)
arrow(ax, (6.1, 8.05), (6.4, 7.22), "YES", GREEN)
box(ax, 3.7, 4.9, 3.8, 1.0, "Unresponsive or\nabnormal breathing", RED, 10)
box(ax, 8.0, 4.9, 3.0, 1.0, "Other red flag?", BLUE, 10)
arrow(ax, (5.55, 6.4), (4.3, 5.42), "NO / UNSURE", RED)
arrow(ax, (7.0, 6.4), (7.7, 5.42), "YES", BLUE)
box(ax, 3.7, 2.9, 3.8, 1.0, "112 · AED · CPR\nFollow dispatcher", RED, 11)
box(ax, 8.0, 2.9, 3.0, 1.0, "112 if yes\nCh. 5 if no", BLUE, 10)
arrow(ax, (3.7, 4.38), (3.7, 3.42), color=RED)
arrow(ax, (8, 4.38), (8, 3.42), color=BLUE)
ax.text(5, 1.25, "Gasping is not normal breathing. Do not delay the call to finish the chart.", ha="center", color=MUTED, fontsize=9)
